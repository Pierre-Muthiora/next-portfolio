...
import ContactImg from "../public/codepic1.jpg";
  ...
  return (
    <div id="contact" className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full ">
        ...
        <h2 className="py-4">Halla at your developer</h2>
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">Pierre Ng&apos;ash</h2>
                <p>Front-End Developer</p>
                <p className="py-4">
                  Also available for freelance and full-time positions. Contact
                  me and let&apos;s talk.
                </p>
              </div>
              <div>
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300 animate-bounce">
              <HiOutlineChevronDoubleUp className="text-[#39FF14]" size={30} />
            </div>
          </Link>
        </div>
      </div>
